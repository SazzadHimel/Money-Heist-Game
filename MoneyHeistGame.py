...
def Draw_House():
    ...
    for house in house_area:
        if (gameover == False and pause == False):
            ...
            if (house['condition'] == 'looting' and house['health'] < 5): # 25, 180, 45 + 100, 180
...
def Animation():
    glutPostRedisplay()
    global LootTiming, HouseHealth, Bullet, Score, fast_travel_left, gameover, tank, house_area, restart, printGameOver, speed, pause
    speed += 0.003
